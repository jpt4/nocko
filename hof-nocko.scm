...
;;  deep even addresses
      [(== `[,adr ,b] i) (gtheo adr '(num (0 0 1))) (+o a a adr) 
       (fas `[,a ,b] res1)
       (fas `[(num (0 1)) ,res1] res2) (== res2 o)]
;;  deep odd addresses
      [(== `[,adr ,b] i) (gtheo adr '(num (1 1))) 
       (+o a a res1) (+1o res1 adr) (fas `[,a ,b] res2)
       (fas `[(num (1 1)) ,res2] res3) (== res3 o)]
...
(define (tar i o)
  (conde
    (fresh (a b c d res1 res2)
;;  composite application redex
      [(== `[,a [[,b ,c] ,d]] i) (tar `[,a [,b ,c]] res1)
       (tar `[,a ,d] res2) (== `[,res1 ,res2] o)]
;;  redex zero
      [(== `[,a [(num (0)) ,b]]) i) (fas `[,b ,a] res)]
;;  redex one
      [(== `[,a [(num (1)) ,b]]) i) 
       (houn?o a) (houn?o b)
       (== b o)]
